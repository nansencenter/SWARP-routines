...
if region == 'bar':
   ...
   nci = Mdrg.nc_getinfo(self.wavesice)
   vo = Mdrg.make_plot_options('dmax',ice_mask=True)
   nci.make_png_all(vo,HYCOMreg='bar',figdir='.')
   ...
   nci = Mdrg.nc_getinfo(self.wavesice)
   vo = Mdrg.make_plot_options('dmax',ice_mask=True)
   nci.make_png_all(vo,HYCOMreg='gre',figdir='.')
   ...
   nci = Mdrg.nc_getinfo(self.wavesice)
   vo = Mdrg.make_plot_options('dmax',ice_mask=True)
   nci.make_png_all(vo,HYCOMreg='bar',figdir='./bar')
   nci.make_png_all(vo,HYCOMreg='gre',figdir='./gre')
