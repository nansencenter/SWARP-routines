...
class poly_stat:
	...
	def __init__(self,cont,poly_status,OUT,INS,DIFF,X,Y,number,typo,basemap=None,PLOT=None,STCH=None):
		...
		if self.region == 'Barents_Kara_sea':
			...
			lab_m_widths.append([self.med_width])
			lab_area.append([self.p_area])
			lab_perim.append([self.p_perim])
		elif self.region == 'Laptev_East_Siberian_sea':
			les_m_widths.append([self.med_width])
			les_area.append([self.p_area])
			les_perim.append([self.p_perim])
		elif self.region == 'North_Canada_Beaufort_sea':
			ncb_m_widths.append([self.med_width])
			ncb_area.append([self.p_area])
			ncb_perim.append([self.p_perim])
