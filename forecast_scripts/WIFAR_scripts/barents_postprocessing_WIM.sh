...
WORKDIR=/work/bergh/BS1a0.045/expt_01.6/data/
#CRONDIR=/home/nersc/dany/.cron/
ARCHDIR=/bcmhsm/nersc/bergh/WIFAR/BS1a0.045/Operational_WIM/
region=barents_WIM
...
cd $MAINDIR
echo " * Launching barents_ice_forecast_WIM.sh $region $julday $year_start"
echo ""
$MAINDIR/barents_ice_forecast_WIM.sh $region $julday $year_start
