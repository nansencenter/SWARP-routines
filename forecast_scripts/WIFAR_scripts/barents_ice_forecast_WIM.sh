...
WORKDIR=$MAINDIR/workdir3
jobdir=workdir3
# WEBDIR=$MAINDIR/webpage
EXPDIR=/work/bergh/BS1a0.045/expt_01.6/data/
...
echo "-------------------------------------------------------------------------"
echo " barents_ice_forecast_WIM.sh"
echo "-------------------------------------------------------------------------"
echo ""
...
ln -sf $EXPDIR/BS1DAILY_${valyear3}_${valday3}_${valyear3}_${valday3}.* $WORKDIR
...
##echo "***********************************************************"
##echo "****** For now copy figures directly to WIM Archive *******"
echo "***********************************************************"
