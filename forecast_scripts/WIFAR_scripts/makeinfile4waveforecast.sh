...
# 4. to_day (+0)
# 5. to_day (+1)
# DONT USE THIS FOR WAVE, ONLY 2 DAYS! 6. to_day (+2 at 00:00 and 12:00UTC)
...
then
  ...
  echo "-------------------------------------------------------------------------"
  echo " makeinfile4waveforecast.sh $1"
  echo "-------------------------------------------------------------------------"
  ...
  then
    ...
    echo " ERROR : infile.mal.wave does not exist" 
    exit
  fi
fi
