...
###########################################################
def MIZmap(fobj,var_name='dmax',vertices=None,\
...
###########################################################
def areas_of_disagreement(fobj,obs_type='OSISAF',do_sort=True,EastOnly=True,plotting=True,**kwargs):
   ...
   if obs_type == 'OSISAF':
      ...
      obsfil   = '/work/shared/nersc/msc/OSI-SAF/'+\
            fobj.datetime.strftime('%Y')+'_nh_polstere/'+\
            'ice_conc_nh_polstere-100_multi_'+\
            fobj.datetime.strftime('%Y%m%d')+'1200.nc'
   else:
